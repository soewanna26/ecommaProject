<header class="header_section">
    <div class="container">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
            <a class="navbar-brand" href="{{ Auth::check() ? route('account.dashboard') : route('home') }}"><img
                    width="250" src="{{ asset('images/logo.png') }}" alt="#" /></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item {{ Request::routeIs('product_page') ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ Request::routeIs('customer_order') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('customer_order') }}">Order</a>
                    </li>
                    <li class="nav-item {{ Request::routeIs('show_cart') ? 'active' : '' }}">
                    ...
                    @if (Auth::check())
                        <li class="nav-item mr-2">
                            <a class="btn btn-secondary" href="{{ route('account.logout') }}">Logout</a>
                        </li>
                    @else
                        <li class="nav-item mr-2">
