                    ...
                    <div class="row g-0">
                        <div
                            ...
                            <div style="max-width: 25rem;">
                                ...
                                <!-- Image block -->
                                <div class="">
                                    <img src="{{ asset('login/images/login-shop.svg') }}" alt="login-img"
                                        width="300px">
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                                @include('message')
                                <!-- Form -->
                                <form class="row g-1 p-3 p-md-4" action="{{ route('account.processRegister') }}"
                                    method="post">
                                    @csrf
                                    ...
                                    <div class="col-12">
                                        ...
                                        is-invalid
                                    @enderror"
                                                name="password" id="password" placeholder="6+ characters">
                                            @error('password')
                                                <p class="invalid-feedback">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12 text-center mt-4">
                                        <button type="submit"
                                            class="btn btn-lg btn-block btn-success lift text-uppercase">Sign
                                            Up</button>
                                    </div>
                                    <div class="col-12 text-center mt-4">
                                        <span class="text-muted">Already have an account? <a
                                                href="{{ route('account.login') }}" title="Sign in">Sign in
                                                here</a></span>
                                    </div>
                                </form>
                                <!-- End Form -->
